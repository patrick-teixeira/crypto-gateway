      ...
      <div className="hidden lg:flex lg:w-1/2 bg-foreground text-background flex-col justify-between p-12">
        <div>
          <div className="flex items-center gap-2">
            <div className="size-8 rounded-md bg-background" />
            <span className="text-xl font-semibold tracking-tight">Radix</span>
          </div>
        </div>
        
        <div className="space-y-6">
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-balance">
            A plataforma completa para construir a web.
          </h1>
          <p className="text-lg text-background/70 leading-relaxed">
            Crie, implante e escale as melhores experiências web com nossa plataforma.
          </p>
        </div>

        <div className="flex items-center gap-8 text-sm text-background/60">
          <div className="space-y-1">
            <p className="text-2xl font-bold text-background">98%</p>
            <p>mais rápido</p>
          </div>
          <div className="h-12 w-px bg-background/20" />
          <div className="space-y-1">
            <p className="text-2xl font-bold text-background">300%</p>
            <p>aumento em SEO</p>
          </div>
          <div className="h-12 w-px bg-background/20" />
          <div className="space-y-1">
            <p className="text-2xl font-bold text-background">6x</p>
            <p>mais eficiente</p>
          </div>
        </div>
      </div>
